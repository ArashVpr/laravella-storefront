        ...
        <div class="max-w-md w-full bg-white rounded-3xl shadow-xl overflow-hidden border border-gray-100">
            <div class="px-8 py-10">
                ...
                <form action="{{ route('login.store') }}" method="POST" class="space-y-6">
                    ...
                    <div>
                        ...
                        <div class="mt-2 text-xs bg-gray-50 text-gray-500 p-2 rounded-lg border border-gray-100 inline-block">
                             <span class="font-semibold">Demo:</span> akoelpin@example.net
                        </div>
                    </div>
                    ...
                    <div>
                        <div class="flex justify-between items-center mb-1">
                            ...
                            <a href="{{ route('password.forgot') }}" class="text-sm font-medium text-primary hover:text-primary-hover">Forgot password?</a>
                        </div>
                        ...
                        <!-- Demo Credential Hint -->
                        <div class="mt-2 text-xs bg-gray-50 text-gray-500 p-2 rounded-lg border border-gray-100 inline-block">
                             <span class="font-semibold">Demo:</span> password
                        </div>
                    </div>
                ...
                <p class="mt-8 text-center text-sm text-gray-600">
                    ...
                    <a href="{{ route('signup') }}" class="font-bold text-primary hover:text-primary-hover transition-colors">Sign up</a>
                </p>
            </div>
        </div>
    </div>
