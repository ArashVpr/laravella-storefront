<x-app title="{{ __('Signup') }}" bodyClass="bg-gray-50 h-full">
        ...
        <div class="max-w-md w-full bg-white rounded-3xl shadow-xl overflow-hidden border border-gray-100">
            <div class="px-8 py-10">
                <div class="text-center mb-8">
                    <h2 class="text-3xl font-black text-gray-900 tracking-tight">{{ __('Create Account') }}</h2>
                    <p class="mt-2 text-sm text-gray-500">{{ __('Join our community today') }}</p>
                </div>
                ...
                <p class="mt-8 text-center text-sm text-gray-600">
                    ...
                    <a href="{{ route('login') }}" class="font-bold text-primary hover:text-primary-hover transition-colors">{{ __('Sign in') }}</a>
                </p>
            </div>
        </div>
    </div>
