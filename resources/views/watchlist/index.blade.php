<x-app title="Watchlist">
    <div class="container mx-auto px-4 py-8">
        <div class="flex justify-between items-end mb-8">
            <h1 class="text-3xl font-black text-gray-900 tracking-tight">My Watchlist</h1>
             @if ($cars->total() > 0)
                <p class="text-sm text-gray-500 mb-1">
                    Showing {{ $cars->firstItem() }}-{{ $cars->lastItem() }} of {{ $cars->total() }} cars
                </p>
            @endif
        </div>
        ...
        @else
             <div class="text-center py-20 bg-gray-50 rounded-3xl border border-gray-100 border-dashed">
                ...
                <h3 class="text-lg font-bold text-gray-900 mb-2">No favorites yet</h3>
                <p class="text-gray-500 mb-6">Start browsing to add cars to your watchlist.</p>
