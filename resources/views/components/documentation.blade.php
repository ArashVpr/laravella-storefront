<x-app title="Documentation">
    <div style="max-width: 800px; margin: 40px auto; padding: 20px; font-family: sans-serif; line-height: 1.6; color: #333;">
        ...
        <p>car-hub.xyz is a Laravel-based web application designed for managing cars, their features, and user interactions such as watchlists and authentication. It leverages Laravel's built-in features like Eloquent ORM, Blade templates, and Sanctum for API authentication.</p>
        ...
        <ul>
            ...
            <li>Configure your database in <code>.env</code> and run migrations: <code>php artisan migrate --seed</code></li>
        ...
        <ul>
            <li><strong>Environment Variables:</strong> Configure the <code>.env</code> file for database, mail, and third-party services.</li>
            <li><strong>Queue Configuration:</strong> Update <code>queue.php</code> for queue drivers like Redis or database.</li>
        ...
        <h2 id="database-structure" style="font-size: 20px; font-weight: bold; margin-top: 30px;">Database Structure</h2>
        <p>Tables:</p>
        <ul>
            ...
            <li><code>personal_access_tokens</code>: For API authentication.</li>
        </ul>
    
        <h2 id="factories-seeders" style="font-size: 20px; font-weight: bold; margin-top: 30px;">Factories and Seeders</h2>
        ...
        <h2 id="styling-frontend" style="font-size: 20px; font-weight: bold; margin-top: 30px;">Styling and Frontend</h2>
        <ul>
        ...
        <ul>
            <li><strong>Socialite:</strong> Google and Facebook OAuth login. Configured in <code>services.php</code>.</li>
            <li><strong>Sanctum:</strong> API authentication. Configured in <code>sanctum.php</code>.</li>
            <li><strong>Filament Admin Panel:</strong> Admin panel for managing resources. Configured in <code>AdminPanelProvider.php</code>.</li>
        </ul>
    
        <h2 id="deployment" style="font-size: 20px; font-weight: bold; margin-top: 30px;">Deployment (with GitHub Actions)</h2>
        <p>The application uses GitHub Actions for Continuous Integration and Deployment (CI/CD). The deployment process is automated and triggered on the creation of a new release.</p>
        ...
        <ul>
            <li><strong>Trigger:</strong> The workflow is triggered when a new release is created in the GitHub repository.</li>
            <li><strong>Build Steps:</strong>
                <ul>
                    ...
                    <li>Laravel-specific tasks like generating the encryption key, creating a storage link, and running migrations are executed.</li>
                    <li>Frontend assets are built.</li>
                    <li>Tests are run to ensure the application is functioning correctly.</li>
                </ul>
            </li>
            <li><strong>Deployment:</strong> The app is deployed to the server using the <code>appleboy/ssh-action</code>. The server pulls the latest release tag, installs dependencies, builds assets, and optimizes the Laravel app.</li>
        </ul>
