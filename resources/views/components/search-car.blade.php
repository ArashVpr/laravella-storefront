            ...
            <div class="find-a-car-inputs">
                ...
                <div>
                    ...
                    <select id="citySelect" name="city_id" aria-label="Select city" style="border-radius: 8px; border: 2px solid #e5e7eb;">
                        <option value="" style="display: block">🏙️ City</option>
                ...
                <div>
                    ...
                    <input type="number" placeholder="📅 Year From" name="year_from" id="yearFrom" value="{{ request('year_from') }}"
                        aria-label="Minimum year" style="border-radius: 8px; border: 2px solid #e5e7eb;" />
                </div>
                <div>
                    <label for="yearTo" class="sr-only">Year To</label>
                    <input type="number" placeholder="📅 Year To" name="year_to" id="yearTo" value="{{ request('year_to') }}"
                ...
                <div>
                    ...
                    <input type="number" placeholder="💰 Min Price" name="price_from" id="priceFrom" value="{{ request('price_from') }}"
                        aria-label="Minimum price" style="border-radius: 8px; border: 2px solid #e5e7eb;" />
                </div>
                <div>
                    <label for="priceTo" class="sr-only">Price To</label>
                    <input type="number" placeholder="💰 Max Price" name="price_to" id="priceTo" value="{{ request('price_to') }}"
